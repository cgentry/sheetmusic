...
class DbHelper:
    ...
    @staticmethod
    def fetchone( sql:str , param=None, name:str=None, default=None, index:int=0, debug=False)->str:
    ...
    @staticmethod
    def fetchrow( sql:str , param, fields:list, debug=False)->dict:
    ...
    @staticmethod
    def fetchrows( sql:str , param, fields:list )->list:
        query = DbHelper.bind( DbHelper.prep(sql) , param )
        if query.exec():
