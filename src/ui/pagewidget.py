...
from ui.pagelabelwidget import PageLabelWidget
from ui.bottomsheet import BottomSheet

class PageWidget( BottomSheet):
    ...
    def __init__(self, MainWindow: QMainWindow):
        super().__init__( MainWindow , u'PageWidget')
 
    def content_generator( self , obj_name:str )->PageLabelWidget:
        obj= PageLabelWidget( obj_name)
        obj.widget().setObjectName( obj_name )
        return obj
